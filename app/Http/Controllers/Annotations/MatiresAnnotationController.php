 ...
 * @OA\Response(response="404", description="Not Found"),
 *     @OA\Parameter(in="path", name="matiere", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     tags={"Matières"},
 ...
 * @OA\PUT(
 *     path="/api/matieres/{matiere}",
 *     summary="Modifier les informations d'une matiere",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
...
*/
 ...
 class MatiresAnnotationController {}
